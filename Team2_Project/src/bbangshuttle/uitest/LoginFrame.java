        ...
        getContentPane().add(loginPanel);
                ...
                IdSearchButton.addActionListener(new ActionListener() {
    	            ...
    	            public void actionPerformed(ActionEvent e) {
    	                ...
    	                String memberEmail = JOptionPane.showInputDialog(LoginFrame.this, "이메일을 입력하세요:");
    	                if (memberEmail != null && !memberEmail.isEmpty()) {
    	                    try {
    	                        ...
    	                        if (email != null) {
    	                            ...
    	                            JOptionPane.showMessageDialog(LoginFrame.this, "검색된 이메일: " + memberEmail, "이메일 찾기 결과", JOptionPane.INFORMATION_MESSAGE);
    	                        } else {
    	                            JOptionPane.showMessageDialog(LoginFrame.this, "검색된 이메일이 없습니다.", "이메일 찾기 결과", JOptionPane.INFORMATION_MESSAGE);
    	                        }
    	                    } catch (Exception ex) {
    	                        ex.printStackTrace();
    	                        JOptionPane.showMessageDialog(LoginFrame.this, "이메일 검색 과정에서 오류가 발생했습니다.", "Error", JOptionPane.ERROR_MESSAGE);
    	                    }
    	                } else {
    	            ...
    	            public void actionPerformed(ActionEvent e) {
    	                ...
    	                if (memberId != null && !memberId.isEmpty()) {
    	                    try {
    	                        ...
    	                        if (id != null) {
    	                            // Display the ID using a dialog box
    	                            JOptionPane.showMessageDialog(LoginFrame.this, "검색된 아이디: " + memberId, "아이디 찾기 결과", JOptionPane.INFORMATION_MESSAGE);
    	                        } else {
    	                            JOptionPane.showMessageDialog(LoginFrame.this, "검색된 아이디가 없습니다.", "아이디 찾기 결과", JOptionPane.INFORMATION_MESSAGE);
    	                        }
    	                    } catch (Exception ex) {
    	                        ex.printStackTrace();
    	                        JOptionPane.showMessageDialog(LoginFrame.this, "아이디 검색 과정에서 오류가 발생했습니다.", "Error", JOptionPane.ERROR_MESSAGE);
    	                    }
    	                } else {
