...
public class CartSQL {
	...
	//" "회원 장바구니 " "품목 하나 업데이트
	public static final String CART_MEMBERID_UPDATE = "update cart set cart_qty= ? where member_id = ?  and p_no = ? ";
	//" "회원 장바구니 품목 전체 변경
	public static final String CART_MEMBERID_UPDATE_ALL = "update cart set cart_qty = ? where member_id =?";
	//" "회원 장바구니 ""품목 선택 삭제
